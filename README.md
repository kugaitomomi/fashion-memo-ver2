...
This application can save the clothes in your closet as a photo.
...
1. Clone the repo
   SSH
   ```sh
   git clone git@github.com:kugaitomomi/fashion-memo-ver2.git
   ```
   HTTPS
   ```sh
   git clone https://github.com/kugaitomomi/fashion-memo-ver2.git
   ```
